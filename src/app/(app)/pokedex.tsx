...
// Calcula largura do card: 3 por linha com gap
const COLUMNS = 3;
...
const styles = StyleSheet.create({
    ...
    orb: {
        ...
        borderRadius: 9999,
        // @ts-ignore
        filter: isWeb ? 'blur(120px)' : undefined,
        opacity: 0.12,
    },
    orbRed: {
    ...
    header: {
        ...
        paddingHorizontal: isWeb ? 24 : 14,
        paddingVertical: isWeb ? 16 : 10,
        borderBottomWidth: 1,
